...
-- DropIndex (com IF EXISTS para evitar erro se não existir)
DROP INDEX IF EXISTS "avaliacoes_idUser_idCiclo_key";

-- CreateIndex
CREATE UNIQUE INDEX "avaliacoes_idUser_idCiclo_criterioId_key" ON "autoavaliacao"("idUser", "idCiclo", "criterioId");